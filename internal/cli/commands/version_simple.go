...
// NewSimpleVersionCommand creates the version command for simple CLI
func NewSimpleVersionCommand(version, commit, date string) *simplecli.Command {
	return &simplecli.Command{
		...
		Run: func(ctx *simplecli.Context) error {
			return runVersionSimple(ctx, version, commit, date)
		},
	}
}

func runVersionSimple(ctx *simplecli.Context, version, commit, date string) error {
